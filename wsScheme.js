...
/**
 * @typedef {Object} PW_CONNECTOR_TROUBLE_DATA '장치에서 에러가 검출될 경우 발생 및 해결 정보 저장'
...
/**
 * @typedef {Object} PW_INVERTER_DATA '인버터에서 측정된 데이터'
 * @property {number} inverter_data_seq 인버터 데이터 시퀀스 
 * @property {number} inverter_seq 인버터 정보 시퀀스 
 * @property {number} in_a A 
 * @property {number} in_v V 
 * @property {number} in_w W 
 * @property {number} out_a A 
 * @property {number} out_v V 
 * @property {number} out_w W 
 * @property {number} p_f Power Factor 
 * @property {number} l_f 라인 주파수 
 * @property {number} d_wh Daily Power, 단위:Wh 
...
/**
 * @typedef {Object} PW_INVERTER_TROUBLE_DATA '장치에서 에러가 검출될 경우 발생 및 해결 정보 저장'
...
/**
 * @typedef {Object} WC_KMA_DATA '기상청에서 발표한 일기예보를 저장'
...
/**
 * @typedef {Object} PW_MODULE_DATA '접속반에서 측정된 데이터'
...
/**
 * @typedef {Object} PW_PHOTOVOLTAIC '수중 태양광 모듈 상세 정보'
 * @property {number} photovoltaic_seq 모듈 세부 정보 시퀀스 
...
/**
 * @typedef {Object} PW_PHOTOVOLTAIC_TROUBLE_DATA '장치에서 에러가 검출될 경우 발생 및 해결 정보 저장'
...
/**
 * @typedef {Object} WC_WEATHER_LOCATION '기상청의 날씨 API를 가져올 위치값 테이블'
 * @property {number} weather_location_seq 기상청 정보 위치 시퀀스 
...
/**
 * @typedef {Object} PW_INVERTER '인버터 장치 상세 정보'
 * @property {number} inverter_seq 인버터 정보 시퀀스 
 * @property {string} target_id 인버터 id 
 * @property {string} target_name 인버터 명 
...
/**
 * @typedef {Object} PW_CONNECTOR '접속반 상세 정보'
 * @property {number} connector_seq 접속반 정보 시퀀스 
 * @property {string} target_id 접속반 id 
 ...
 * @property {number} data_logger_def_seq 데이터 로거 개요 시퀀스 
 * @property {number} main_seq MAIN 시퀀스 
 * @property {string} dl_real_id _id` VARCHAR(38) NULL COLLATE 'utf8_general_ci 
 ...
 * @property {string} m_name 지역 이름' COLLATE 'utf8_general_ci 
 ...
 * @property {string} node_real_id al_id` VARCHAR(38) NULL COLLATE 'utf8_general_ci 
...
/**
 * @typedef {Object} V_DV_NODE_PROFILE
 * @property {number} node_seq 노드 정보 시퀀스 
 * @property {string} node_real_id al_id` VARCHAR(38) NULL COLLATE 'utf8_general_ci 
 * @property {string} node_id ` VARCHAR(26) NULL COLLATE 'utf8_general_ci 
 * @property {string} node_name me` VARCHAR(61) NULL COLLATE 'utf8_general_ci 
 * @property {string} target_code 노드 ID(001, 002, ...)' COLLATE 'utf8_general_ci 
 * @property {number} data_logger_index 해당 센서 데이터의 데이터 로거 인덱스(Default 0) 
 * @property {string} dl_real_id _id` VARCHAR(38) NULL COLLATE 'utf8_general_ci 
 * @property {string} dl_id VARCHAR(26) NULL COLLATE 'utf8_general_ci 
 * @property {string} nd_target_prefix 해당 프로젝트에서 쓸 접두사' COLLATE 'utf8_general_ci 
 ...
 * @property {string} nc_target_name 장치 명(한글)' COLLATE 'utf8_general_ci 
 * @property {string} nc_data_unit cm, kWh, m/s, m 등등' COLLATE 'utf8_general_ci 
 * @property {string} nc_description 부연 설명이 필요한 경우' COLLATE 'utf8_general_ci 
 * @property {string} m_name 지역 이름' COLLATE 'utf8_general_ci 
 * @property {number} node_def_seq 노드 개요 정보 시퀀스 
 * @property {number} node_class_seq 노드 목록 시퀀스 
 ...
 * @property {number} place_class_seq 장소 대분류 시퀀스 
 * @property {number} main_seq MAIN 시퀀스 
 * @property {string} uuid uuid' COLLATE 'utf8_general_ci 
 * @property {string} m_name 지역 이름' COLLATE 'utf8_general_ci 
 * @property {string} place_id d` VARCHAR(26) NULL COLLATE 'utf8_general_ci 
 * @property {string} place_real_id eal_id` VARCHAR(38) NULL COLLATE 'utf8_general_ci 
 ...
 * @property {string} p_target_name 장소 명' COLLATE 'utf8_general_ci 
 * @property {number} depth 장소 상대적 위치 
 * @property {string} place_info 장소 상세 정보' COLLATE 'utf8_general_ci 
 * @property {string} chart_color 차트 색상' COLLATE 'utf8_general_ci 
 * @property {number} chart_sort_rank 차트 정렬 순위 
 ...
 * @property {string} main_name 지역 이름' COLLATE 'utf8_general_ci 
...
/**
 * @typedef {Object} V_PW_INVERTER_PROFILE
 * @property {number} inverter_seq 인버터 정보 시퀀스 
 * @property {string} target_id 인버터 id' COLLATE 'utf8_general_ci 
 * @property {string} target_name 인버터 명' COLLATE 'utf8_general_ci 
 * @property {string} target_category 장치 카테고리' COLLATE 'utf8_general_ci 
 * @property {string} connect_info 접속 정보' COLLATE 'utf8_general_ci 
 * @property {string} protocol_info 장치 프로토콜 정보' COLLATE 'utf8_general_ci 
 * @property {string} install_place 설치 장소' COLLATE 'utf8_general_ci 
 * @property {string} serial_number 고유 코드' COLLATE 'utf8_general_ci 
 * @property {number} amount 단위: Wh (10:1 Scale) 
 ...
 * @property {number} weather_location_seq 기상청 정보 위치 시퀀스 
 * @property {string} uuid uuid' COLLATE 'utf8_general_ci 
 * @property {string} name 지역 이름' COLLATE 'utf8_general_ci 
 * @property {string} map 맵 파일 정보' COLLATE 'utf8_general_ci 
 * @property {string} address 주소' COLLATE 'utf8_general_ci 
 * @property {string} ip 아이피' COLLATE 'utf8_general_ci 
 * @property {string} gcm_senderid GCM_ID' COLLATE 'utf8_general_ci 
 * @property {number} is_deleted 삭제여부 
 * @property {Date} writedate 생성일 
 * @property {Date} updatedate 수정일 
 */
...
/**
 * @typedef {Object} V_PW_INVERTER_STATUS
 * @property {number} inverter_seq 인버터 정보 시퀀스 
 * @property {string} target_id 인버터 id' COLLATE 'utf8_general_ci 
 * @property {string} target_name 인버터 명' COLLATE 'utf8_general_ci 
 * @property {string} target_category 장치 카테고리' COLLATE 'utf8_general_ci 
...
/**
 * @typedef {Object} V_PW_MODULE_DATA
 * @property {number} photovoltaic_seq 모듈 세부 정보 시퀀스 
 * @property {Date} writedate 등록일 
 * @property {number} avg_amp  
 * @property {number} avg_vol  
 * @property {string} hour_time me` VARCHAR(10) NULL COLLATE 'utf8mb4_general_ci 
 */


/**
 * @typedef {Object} V_PW_MODULE_STATUS
 * @property {number} photovoltaic_seq 모듈 세부 정보 시퀀스 
 ...
 * @property {string} cnt_target_name 접속반 명' COLLATE 'utf8_general_ci 
 * @property {string} cnt_connect_info 장치 접속 정보' COLLATE 'utf8_general_ci 
 * @property {string} cnt_protocol_info 장치 프로토콜 정보' COLLATE 'utf8_general_ci 
 ...
 * @property {string} ivt_target_category 장치 카테고리' COLLATE 'utf8_general_ci 
 * @property {string} ivt_target_name 인버터 명' COLLATE 'utf8_general_ci 
 * @property {string} ivt_connect_info 접속 정보' COLLATE 'utf8_general_ci 
 * @property {string} ivt_protocol_info 장치 프로토콜 정보' COLLATE 'utf8_general_ci 
